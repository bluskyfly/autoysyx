...
_source: https://ysyx.oscc.cc/en/ics-pa/2.3.html_

## Outline
-   [Runtime](#runtime)
-   [Encapsulate the runtime environment into library functions](#encapsulate-the-runtime-environment-into-library-functions)
-   [AM - bare-metal runtime environment](#am-bare-metal-runtime-environment)
-   [RTFSC(3)](#rtfsc-3)
-   [Implement Library for common functions](#implement-library-for-common-functions)
-   [Know computers once again: Computer is an abstraction layer](#know-computers-once-again-computer-is-an-abstraction-layer)
