...
_source: https://ysyx.oscc.cc/en/ics-pa/2.2.html_

## Outline
- [RTFSC(2)](#rtfsc-2)
- [Run the first C program](#run-the-first-c-program)
- [Run more programs](#run-more-programs)
...
你和一个项目的关系会经历4个阶段:
- 被驾驭: 你对它一无所知
- 一知半解: 你对其中的主要模块和功能有了基本的了解
- 驾轻就熟: 你对整个项目的细节都了如指掌
- 为你所用: 你可以随心所欲地在项目中添加你认为有用的功能
...
- mips32 `apt-get install g++-mips-linux-gnu binutils-mips-linux-gnu`
- riscv32(64) `apt-get install g++-riscv64-linux-gnu binutils-riscv64-linux-gnu`
...
### [#](#取指-instruction-fetch-if) 取指(instruction fetch, IF)
...
### [#](#译码-instruction-decode-id) 译码(instruction decode, ID)
