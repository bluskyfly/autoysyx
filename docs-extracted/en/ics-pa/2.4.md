...
_source: https://ysyx.oscc.cc/en/ics-pa/2.4.html_

## Outline
-   [A tool for bug diagnostics - tracer](#a-tool-for-bug-diagnostics-tracer)
-   [AM as infrastructure](#am-as-infrastructure)
-   [Test your klib](#test-your-klib)
-   [Differential Testing](#differential-testing)
-   [One-click regression testing](#one-click-regression-testing)
...
#### [#](#指令环形缓冲区-iringbuf) 指令环形缓冲区 - iringbuf
...
- x86: 无
- riscv32: 无
- mips32: 各种跳转指令 这是因为`mips32-NEMU`没有实现分支延迟槽, 可以通过`difftest_skip_dut(2, 1)`来校准
