...
_source: https://ysyx.oscc.cc/en/ics-pa/4.5.html_

## Outline
-   [Showcasing your computer system](#showcasing-your-computer-system)
-   [Run ONScripter simulator](#run-onscripter-simulator)
- [Next Semester Preview - Operating Systems Course Padding](#next-semester-preview-operating-systems-course-padding)
- [From one to infinity](#from-one-to-infinity)
