...
_source: https://ysyx.oscc.cc/ics-pa-src/install.html_

---

# [#](#see-https-github-com-gitbookio-gitbook-blob-master-docs-setup-md) see https://github.com/GitbookIO/gitbook/blob/master/docs/setup.md

apt-get install npm npm install gitbook-cli -g
`
