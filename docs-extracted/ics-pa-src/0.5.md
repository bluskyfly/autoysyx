...
_source: https://ysyx.oscc.cc/ics-pa-src/0.5.html_

## Outline
-   [Learning to use basic tools](#learning-to-use-basic-tools)
-   [Installing tmux](#installing-tmux)
-   [Why GNU/Linux and How to](#why-gnu-linux-and-how-to)
