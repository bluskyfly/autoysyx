...
####  __如果你的系统不是Ubuntu 22.04, 请更换合适的源

使用与系统不相符的源会导致工具包版本冲突, 强行安装将会损坏系统. 如果你使用的系统不是Ubuntu 22.04, 请勿使用以下的源, 你可以在[这里在新窗口中打开](<https://mirrors.bfsu.edu.cn/help/ubuntu/>)选择相应的Ubuntu版本, 并将源更换成选择的结果.
...
#### __遇到could not resolve 'cn.mirrors.tuna.tsinghua.edu.cn'的错误
...
[ First Exploration with GNU/Linux ](</docs/ics-pa/0.2.html>)[ Configuring vim ](</docs/ics-pa/0.4.html>)
