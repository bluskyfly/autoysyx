...
`vim` is called [编辑器之神在新窗口中打开](<https://code2048.com/post/war_3_editor/>). You will use `vim` for coding in all PAs and Labs, as well as editing other files. If you prefer to `emacs`, you can download and install `emacs` from network mirrors.
...
#### __Some games operated with vim

Here are some games to help you master some basic operations in `vim`. Have fun!

  * [Vim Adventures在新窗口中打开](<http://vim-adventures.com>)
  * [Vim Snake在新窗口中打开](<http://www.vimsnake.com>)
  * [Open Vim Tutorials在新窗口中打开](<http://www.openvim.com/tutorial.html>)
  * [Vim Genius在新窗口中打开](<http://www.vimgenius.com>)
...
We present the modification with [GNU diff format在新窗口中打开](<http://www.gnu.org/software/diffutils/manual/html_node/Unified-Format.html>). If you do not understand the diff format, please search the Internet for more information.
...
正确的STFW方式能够增加找到解决方案的概率, 包括
  ...
  * 使用[英文维基百科在新窗口中打开](<http://en.wikipedia.org>)查阅概念
  * 使用[stack overflow问答网站在新窗口中打开](<http://stackoverflow.com>)搜索程序设计相关问题
...
[ Installing Tools ](</docs/ics-pa/0.3.html>)[ More Exploration ](</docs/ics-pa/0.5.html>)
